...
class Cursos extends BaseCursos
{
    ...
    public function relations() {
        return array(
            // Relación con la tabla 'inscripcion'
            'inscripciones' => array(self::HAS_MANY, 'Inscripcion', 'cur_codigo'),

            // Relación con la tabla 'participante' a través de 'inscripcion'
            'participantes' => array(self::HAS_MANY, 'Participante', array('par_codigo' => 'par_codigo'), 'through' => 'inscripciones'),

            // Relación con la tabla 'notas' a través de 'inscripcion'
            'notas' => array(self::HAS_MANY, 'Notas', array('ins_codigo' => 'ins_codigo'), 'through' => 'inscripciones'),
        );
    }
