...
<h3><?php echo Yii::t('app', 'CERTIFICADOS  -  VISTA ADMINISTRADOR'); ?></h3>
...
<table border="1" class="tabla_reporte">
	...
	<tr>            
        ...
        <td align="lef"><?php echo  $data['cer_registro']?></td>
        ...
        <td align="center"><?php echo '<a href="http://webltga.espe.edu.ec/sg-uec/certificados/'.$data['cer_nombre'].'"><img src="/sg-ri/images/print.png"/></a>'?></td>
        </tr>
	<?php } ?>
</table>
