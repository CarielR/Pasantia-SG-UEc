            ...
            <tbody>
                <?php foreach ($resultado as $registro): ?>
                    <tr>
                        ...
                        <td>
                            <!-- Verificamos si existe el índice 'asi_asistencia' -->
                        ...
                        <td>
                            <!-- Verificamos si existe el índice 'asi_observacion' -->
...
<?php else: ?>
    ...
    <p>No existe registros de asistencia para la fecha seleccionada.</p>
    <form method="post">
