...
; ?>
                    ...
                    <?php echo $form->labelEx($model,'pla_creado_por'); ?>
                    <?php echo $form->textField($model, 'pla_creado_por', array('maxlength' => 45,'size' => 45)); ?>
                    <?php echo $form->error($model,'pla_creado_por'); ?>
                    
                                                                    
                    <?php echo $form->labelEx($model,'pla_fecha_creacion'); ?>
                    <?php $form->widget('zii.widgets.jui.CJuiDatePicker', array(
			'model' => $model,
...
; ?>
                    <?php echo $form->error($model,'pla_fecha_creacion'); ?>
                    
                                                                    
                    <?php echo $form->labelEx($model,'pla_modificado_por'); ?>
                    <?php echo $form->textField($model, 'pla_modificado_por', array('maxlength' => 45,'size' => 45)); ?>
                    <?php echo $form->error($model,'pla_modificado_por'); ?>
                    
                                                                    
                    <?php echo $form->labelEx($model,'pla_fecha_modificacion'); ?>
                    <?php $form->widget('zii.widgets.jui.CJuiDatePicker', array(
			'model' => $model,
...
; ?>
                    <?php echo $form->error($model,'pla_fecha_modificacion'); ?>
